// todo 입력 공간 가져오기 - button : click 이벤트로 실행
const todoInput = document.querySelector("#todo-form #todo");
// todo button: click 이벤트로 실행
// button에 아이디를 주지 않았기 때문에, 노드로 접근을 하거나, querySelector를 이용하여 선택자를 이용하여 접근해서 객체를 가져온다
...
function todoCheck(e) {
  ...
  if (e.target.checked) li.style.color = "lightgray";
